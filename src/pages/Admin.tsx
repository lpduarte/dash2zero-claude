  ...
  return (
    <div className={cn(
      ...
      <div className="flex items-start gap-4 mb-4">
        {/* Avatar/Logo */}
        <div className={cn("w-14 h-14 rounded-md flex items-center justify-center overflow-hidden shrink-0 border shadow-md", client.isArchived ? "bg-background" : "bg-card")}>
          {client.logo ? (
            <img
              src={client.logo}
              alt={client.name}
